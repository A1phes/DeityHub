...
function EspInterface.Load()
	if EspInterface._hasLoaded then return warn("Esp has already been loaded.") end
...
function EspInterface.Unload()
	if not EspInterface._hasLoaded then return warn("Esp has not been loaded yet.") end
